...
})(
  {
    "scripts/script.js": [
      function(require, module, exports) {
        // toggle menu sidebar
        var toggle = document.getElementById("toggle"); // obsluga sidebara
        ...
        function refreshDate() {
          ...
          for (var i = 0; i < tableDates.length; i++) {
            console.log(tableDates[i].innerHTML); // if () {
            // }
          }
        }
        ...
        document.addEventListener("DOMContentLoaded", ready); //modal jquery
